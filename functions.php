...
register_sidebar(array(
    ...
    'before_widget' => '<section id="%1$s" class="footer-section">',
...
function enqueue_scripts() {
  ...
  wp_register_style( 'fancybox-css', get_template_directory_uri() . '/_assets/css/jquery.fancybox.min.css', array(), '', 'all' );
  ...
  wp_register_script('jquery', 'https://ajax.googleapis.com/ajax/libs/jquery/1.10.1/jquery.min.js', false, '3.6.0');
  wp_register_script('jqueryui', 'https://code.jquery.com/ui/1.12.1/jquery-ui.min.js', false, '1.12.1');
  ...
  wp_register_script( 'theme', get_template_directory_uri() . '/_assets/scripts/theme.js', array(), true,true );
...
function new_excerpt_more($more) {
   global $post;
  return '[...] <div class="read-more"><a href="'. get_permalink($post->ID) . '">Read Post <i class="fal fa-long-arrow-right"></i></a></div>';
}
...
echo '<link rel="stylesheet" type="text/css" href="'.get_bloginfo('template_directory').'/_lib/login.css" />'; 
}
